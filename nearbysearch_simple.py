...
def nearby(keytup):
    ...
    latitude=keytup[1]
    longitude=keytup[0]
    qpage="https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+str(latitude)+','+str(longitude)+'&radius=5000&'+str(keyword_url)+'&key='+api
    ...
    df3=df3[['place_id','name','types','vicinity','rating','user_ratings_total','Longitude','Latitude']]
